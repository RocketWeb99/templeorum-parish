...
// OPTIONS - PLEASE CONFIGURE THESE BEFORE USE!
	...
	$yourEmail = "piltown@templeorumparish.com"; // the email address you wish to receive these mails through
	$yourWebsite = "http://www.templeorumparish.com"; // the name of your website
	$thanksPage = 'reply.htm'; // URL to 'thanks for sending mail' page; leave empty to keep message on the same page 
...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
	...
	$badwords = array("adult",  "blackjack", "backgammon", "texas", "holdem", "poker", "carisoprodol", "ciara", "ciprofloxacin", "debt", "dating", "porn", "link=", "voyeur");
